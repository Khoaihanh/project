									...
									<tbody>
										<c:forEach items="${c}" var="o">
											<tr>
												<th scope="row">
													<div class="p-2">
														<img src="${o.product_img_source}" alt="" width="70"
															class="img-fluid rounded shadow-sm">
														<div class="ml-3 d-inline-block align-middle">
															<h5 class="mb-0">
																<a href="#" class="text-dark d-inline-block">${o.product_name}</a>
															</h5>
												...
												<td class="align-middle"><a
													href="sub?id=${o.product_id}&&action=subproduc"><button
															class="btnSub">-</button></a> <strong>${o.amoun}</strong> <a
													href="AddToCart?id=${o.product_id}&&action=add"><button
															class="btnAdd">+</button></a></td>
												<td class="align-middle"><a
													href="Remove?id=${o.product_id}&&action=remove"
													class="text-dark">
							...
							<div class="p-4">
								<ul class="list-unstyled mb-4">
									...
									<li class="d-flex justify-content-between py-3 border-bottom"><strong
										...
										<h5 class="font-weight-bold">${thanhtoan}₫</h5></li>
								</ul>

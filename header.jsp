...
<div class='header'>
	...
	<form action="Search" method="get">
		<div class="input-group mb-3 lefthead " style="width: 75%;">
			<span class="input-group-text">Categories</span> <input type="text"
				name="txt" class="form-control"
				placeholder="What are you looking for?" value="${search }">
			<input type="submit" value="Search" class="submit"
				class="input-group-text" style="background-color: orange;" />
...
<div class='topnav'>
	...
	<a href="Homecontroller">Home</a> <a href="Homecontroller">Products</a>
	<a href="#">About</a>

	...
	<div class="page-content">
		<div class="form-v2-content">
			...
			<form class="form-detail" action="Register" method="post">
				...
				<div class="form-row">
					<label for="your_email">Your Email:</label> <input type="text"
						name="email" id="your_email" class="input-text" required
						pattern="[^@]+@[^@]+.[a-zA-Z]{2,6}">
				</div>
				<div class="form-row">
					<label for="full-name">Username:</label> <input type="text"
						name="user" id="full_name" class="input-text"
						placeholder="ex: Lindsey Wilson">
				</div>
				<div class="form-row">
					<label for="password">Password:</label> <input type="password"
						name="pass" id="password" class="input-text" required>
				</div>
				<div class="form-row">
					<label for="comfirm-password">Confirm Password:</label> <input
						type="password" name="rpass" id="confirm_password"
